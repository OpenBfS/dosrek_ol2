                ...
                (function callback() {
                    ...
                    OpenLayers.Request.POST({
                        ...
                        success: function(response) {
                            ...
                            // Original code here - expects geometry, but we return literalic json
                            ...
                            //}
                            if (options.success) {
                            //Original code handles features
                            //    var outputs = {};
                            //    outputs[options.output || 'result'] = features;
                            //    options.success.call(options.scope, outputs);
                            //    BfS code handles WPS stats
                                if (response.responseXML == null){
                                    outputs['result'] = new OpenLayers.Format.JSON().read(response.responseText);
                                    options.success.call(options.scope, outputs);
                                } else {
                                    outputs['result'] = {"error":"Ein Fehler ist aufgetreten"};
                                    options.success.call(options.scope, outputs);
                                }
                            }
                        },
    ...
    setResponseForm: function(options) {
        ...
        this.description.responseForm = {
            rawDataOutput: {
                ...
                // BfS fix here! Hardcode MimeType to force application/json
